...
const creditList = Loadable({
  loader: () => import(/* webpackChunkName: "admin.credit" */ 'components/admin/credit'),
  loading: Loading,
});

const creditForm = Loadable({
  loader: () => import(/* webpackChunkName: "admin.credit" */ 'components/admin/credit.bu/SyllabusDetail'),
  loading: Loading,
});
...
const DesignCurriculum = Loadable({
  loader: () => import(/* webpackChunkName: "admin.credit" */ 'components/admin/credit/curriculum'),
  loading: Loading,
});
